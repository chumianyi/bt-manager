  ...
  Future<ServerStats> fetchStats() async {
    try {
      ...
      return ServerStats(
        ...
        memoryUsage: _parseMemory(memResult)['usage']!.toDouble(),
        memoryTotal: _parseMemory(memResult)['total']!.toInt(),
        memoryUsed: _parseMemory(memResult)['used']!.toInt(),
        swapUsage: _parseSwap(memResult)['usage']!.toDouble(),
        swapTotal: _parseSwap(memResult)['total']!.toInt(),
        swapUsed: _parseSwap(memResult)['used']!.toInt(),
